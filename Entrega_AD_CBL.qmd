...
```{r}
cor.test(datos_RRSS$horas_redes_dia, datos_RRSS$fomo_num)
```
Como vemos, el test da un resultado muy cercano a $0$, por tanto, no hay una correlación aparente entre las horas gastadas en redes y el FOMO. De igual manera, trataremos de representar esto en un gráfico para verlo con más claridad:
